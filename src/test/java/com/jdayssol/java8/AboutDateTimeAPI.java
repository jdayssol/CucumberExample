...
public class AboutDateTimeAPI {
	...
	public void java8_datesAreImmutable() {
		...
		// Les dates LocalDate sont immutables en Java 8. Pour rajouter une heure, on utilise plus, qui va renvoyer une autre date.
	...
	public void java8_convertDateToDateTime() {
		LocalDate today = LocalDate.of(2000, 11, 23);
		...
		LocalDateTime time = today.atTime(14, 50);
	...
	public void java8_getNowWithSpecificClock() {
		...
		// Create a clock that start at the epoch and uses the sytem timezone

		// Avec Clock fixe, on cr�e une heure arret�. Epoch commence au 1/1/1970. 
		// La clock peut aussi �tre utilis� pour faire des tests unitaire.
	...
	@Test
	public void java8_durationAreUsedToDescribeDurationsInFullDays() {
		LocalDateTime now = LocalDateTime.now();
		LocalDateTime future = now.plusDays(1);

		Duration duration = Duration.between(now, future); //calculate the period between now and future

		assertThat(duration.get(ChronoUnit.SECONDS)).isEqualTo(86400);
	}
