...
public class AboutLambdas {
	...
	public void java8_passingFunctionsWithLambdas_WithReturn_WithParentheses_WithCurlyBrackets() {
		...
		String result = yeller.yell("echo", (echo) -> {
			return echo; // Equivalent a la fonction du dessus, mais purifi� en expression lambda. 
			// Le parametre est mis entre parenth�se.
		});
	...
	public void java8_passingFunctionsWithLambdas_WithReturn_WithCurlyBrackets() {
		...
		String result = yeller.yell("echo", echo -> {
			return echo; // Pas besoin de parenth�se quand il n'y a qu'un seul param�tre
		});
	...
	/**
	 * Un supplier est une fonction sans param�tre en entr�e
	 */
	@Test
	...
	public void java8_passingSuppliers() {
		...
		//On a r��crit la m�thode du dessus en �crivant une fonction qui ne prend pas de param�tre en entr�e, et qui renvoi un r�sultat
	...
	public void java8_passingPredicates() {
		...
		boolean hasEcho = yeller.hasEcho(echo -> "echo".equals(echo)); // Un pr�dicat est une fonction qui prend un param�tre et retourne un booleen
	 ...
	 * 
	 * Cr�er des interfaces avec une seule methode permet d'utiliser celle ci comme Lambda facilement.
	 */
	@FunctionalInterface
	...
	public void java8_passingOwnFunctionalInterfaces() {
		...
		// Fonctionne meme avec 3 param�tres
		String myecho = yeller.yell("hello", "echo", "plus",
				(echo1, echo2, echo3) -> echo1 + " " + echo2 + " " + echo3); // FIXME: let your concatenator concatenate :)
