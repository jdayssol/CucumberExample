...
public class AboutOptionals {
	...
	public void optionalsAreOptional() {
		// initialisation d'un optional à null
		Optional<String> optional = Optional.empty(); // FIXME: find out how to create an optional of null
		// ou on récupère un objet potentiellement null
		String thisisNull = null;
		Optional<String> optional2 = Optional.ofNullable(thisisNull);
		String value = optional.orElse("b");

		assertThat(value).isEqualTo("b");
		assertThat(value).isEqualTo(optional2.orElse("b"));
	}
